                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{route('adminsupport.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Support</button>
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="support" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Title</th>
		 ...
		 $(document).ready(function(){
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/support/delete/"+_id,
								success: function (data) {
									
									var oTable = $('#support').dataTable();
									oTable.fnDraw(false);
								},
								error: function (data) {
