                      ...
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                            <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($nature->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$nature->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$nature->name}} <?= $nature->name_ka != ''  ? "--" : "";?> {{$nature->name_ka}}
                          </h4>
                          ...
                          <div class="mt-2">
                              <img width="150" height="150" class="img-responsive " src="{{asset('uploads/nature')}}/{{$nature->image}}" alt="blog-main">
                        </div>
