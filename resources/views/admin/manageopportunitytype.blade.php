                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{route('adminopportunitytype.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Requirement Type</button>
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="opportunitytype" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Name</th>
...
<script src="{{asset('admin/assets/js/datatable/datatables/jquery.dataTables.min.js')}}"></script>
    ...
    <script type="text/javascript">
		 ...
		 $(document).ready(function(){
                ...
                var table = $('#opportunitytype').DataTable({
					processing:true,
					serverSide:true,
					ajax: {
						url: "{{ url('admin/opportunitytype') }}"
					},
					columns: [
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/opportunitytype/delete/"+_id,
								success: function (data) {
									
									var oTable = $('#opportunitytype').dataTable();
									oTable.fnDraw(false);
								},
								error: function (data) {
