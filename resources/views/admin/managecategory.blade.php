          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                ...
                @php
                $total = DB::table('pwa_category')->count();
                @endphp
          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                ...
                @php
                $data = DB::table('pwa_category')->where('status', 1)->count();
                @endphp
          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                ...
                @php
                $data = DB::table('pwa_category')->where('status', 2)->count();
                @endphp
                <h4 class="mb-0 counter">{{$data}}</h4>
              </div>
        ...
        <div class="card">
          <div class="card-header pb-0">
            ...
            <div class="mb-3 text-end">
              <a href="{{route('admincategory.add')}}">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('body').on('click', '#show-delete', function () {
      ...
      $.ajax({
        type: "get",
        url: SITEURL + "/admin/category/delete/"+_id,
