                ...
                <div class="blog-single">
                  <div class="blog-box blog-details">
                    <div class="card banner-wrraper">
                        ...
                        <img class="img-fluid w-100 bg-img-cover" src="{{asset('uploads/support')}}/<?=$support->image;?>" alt="blog-main">
                        @endif
                        </div>
                    <div class="card">
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                               <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($support->created_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$support->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4 class="text-capitalize">{{$support->title}}</h4>
                          <p class="text-capitalize">{{$support->cate}}</p>
                          <p>{{$support->descp}}</p>
