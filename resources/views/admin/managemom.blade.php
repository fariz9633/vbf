                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{route('adminmom.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Mom</button>
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="mom" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Topic</th>
                            <th>Hosted / Posted By</th>
                            <th>Meeting</th>
                            <th>Status</th>
                            <th>Action</th>
                          </tr>
		 ...
		 $(document).ready(function(){
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/mom/delete/"+_id,
								success: function (data) {
									
									var oTable = $('#mom').dataTable();
									oTable.fnDraw(false);
								},
								error: function (data) {
