      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.support.update', ["id"=>$support['det']->id])}}" enctype='multipart/form-data'>
                @csrf
                @method('PUT')
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Title</label>
                  <input class="form-control" id="validationCustom01" type="text" name="title" placeholder="Add Support Title" value="{{$support['det']->title}}" required>
                </div>
                <div class="mb-3">
                          ...
                          <select class="form-select" id="validationCustom04" name="category" required="" >
                            ...
                            @foreach($support['category'] as $cat)
                             @php 
                             $categorysel = ($cat->id == $support['det']->c)?"selected":"";
                             @endphp
                  ...
                  <textarea id="editor" class="form-control is-invalid"  name="textbox" cols="10" rows="2" required="">{{$support->descp}}</textarea>
                </div>
                <div class=" mb-3">
                ...
                <div class="mb-3">
                    <figure class="col-md-3 col-6 img-hover hover-1" itemprop="associatedMedia" itemscope="">
                        <a href="{{asset('uploads/support')}}/<?=$support['det']->image;?>" itemprop="contentUrl" data-size="1600x950" target="_blank">
                          <div>
                              <img src="{{asset('uploads/support')}}/<?=$support['det']->image;?>" itemprop="thumbnail" alt="Image description" class="img-thumbnail" width="150" height="90">
                              </div>
                        </a>
                        <figcaption itemprop="caption description"><?=$support['det']->image;?></figcaption>
                    </figure>
                ...
                <div class="mb-3">
                  <div class="media">
                    ...
                    <div class="media-body text-end">
                      <label class="switch">
                          @php
                          $chk = $support['det']->status == '1' ? "checked" : " ";
                          @endphp
