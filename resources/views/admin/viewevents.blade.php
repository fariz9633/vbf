                      ...
                      <div class="card">
                        <div class="profile-post">
                          <div class="post-header">
                            <div class="media">
                            <!--<img class="img-80 img-thumbnail rounded-circle me-3" src="{{asset('uploads/events')}}/<?=$events->prime_member_image;?>" alt="Generic placeholder image">-->
                              <div class="media-body align-self-center"><a href="#">
                                  <h5 class="user-name text-capitalize">{{$events->prime_member}}</h5></a>
                                <h6 class="text-capitalize">{{$events->prime_member_desig}}</h6>
                              </div>
                            </div>
                          ...
                          <div class="post-body">
                              <h3 class="text-capitalize">{{$events->title}}</h3>
                               <p>{{$events->descp}}</p>
                               <?= $events->prime_member_image != ''  ? "<hr>" : "";?>
                          
                          
                          <div class="mb-2 p-2">
                              <img width="150" height="150" class="img-responsive " src="{{asset('uploads/events')}}/{{$events->prime_member_image}}" alt="blog-main">
                        </div>
