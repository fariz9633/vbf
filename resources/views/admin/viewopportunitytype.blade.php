              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Opportunity Type</li>
                  </ol>
                </div>
              </div>
            </div>
                      ...
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                            <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($opportunitytype->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$opportunitytype->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
