                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{route('adminappversions.add')}}" class="btn btn-square btn-primary" > Add Versions
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                 ...
                 <a href="{{url('admin/appversions/edit')}}/{{$ver->id}}" class="btn btn-outline-primary-2x"><i class="icon-pencil-alt"></i></a>
                 ...
                 <a href="{{route('admin.appversions.view', $ver->id)}}" class="btn btn-outline-success-2x"><i class="fa fa-dot-circle-o"></i></a>
                  </div>
...
// 				// NEWS DELETE SCRIPT
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/appversions/delete/"+_id,
