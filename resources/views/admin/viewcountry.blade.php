                      ...
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                            <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($country->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$country->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$country->name}} <?= $country->name_ka != ''  ? "--" : "";?> {{$country->name_ka}}
                          </h4>
                          ...
                          <div class="mt-2">
                              <img width="150" height="150" class="img-responsive " src="{{asset('uploads/country')}}/{{$country->image}}" alt="blog-main">
                        </div>
