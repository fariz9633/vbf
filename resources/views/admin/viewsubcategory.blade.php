                      ...
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                               <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($subcategory->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$subcategory->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$subcategory->name}} <?= $subcategory->name_ka != ''  ? "--" : "";?> {{$subcategory->name_ka}}
                          </h4>
                          <span> Category - {{$subcategory->category}}</span>
                          
                          <?= $subcategory->image != ''  ? "<hr>" : "";?>
                          
                          
                          <div class="mt-2">
                              <img width="150" height="150" class="img-responsive " src="{{asset('uploads/subcategory')}}/{{$subcategory->image}}" alt="blog-main">
                        </div>
