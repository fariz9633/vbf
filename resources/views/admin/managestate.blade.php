                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{route('adminstate.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add State</button>
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="state" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>State</th>
		 ...
		 $(document).ready(function(){
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/state/delete/"+_id,
