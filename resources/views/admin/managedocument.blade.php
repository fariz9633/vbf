        ...
        <div class="card">
          <div class="card-header pb-0">
            ...
            <div class="mb-3 text-end">
              <a href="{{route('admindocument.add')}}">
                <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Other Document</button>
              </a>
            </div>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              ...
              <table class="display" id="document" style="width:100%">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Title</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('body').on('click', '#show-delete', function () {
      ...
      $.ajax({
        type: "get",
        url: SITEURL + "/admin/document/delete/"+_id,
