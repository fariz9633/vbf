                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{route('adminreferalstatus.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Priorities</button>
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="referalstatus" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Name</th>
...
<script src="{{asset('admin/assets/js/datatable/datatables/jquery.dataTables.min.js')}}"></script>
    ...
    <script type="text/javascript">
		 ...
		 $(document).ready(function(){
                ...
                var table = $('#referalstatus').DataTable({
					processing:true,
					serverSide:true,
					ajax: {
						url: "{{ url('admin/referalstatus') }}"
					},
					columns: [
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/referalstatus/delete/"+_id,
								success: function (data) {
									
									var oTable = $('#referalstatus').dataTable();
									oTable.fnDraw(false);
								},
								error: function (data) {
