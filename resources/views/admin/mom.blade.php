      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.mom.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Topic</label>
                  <input class="form-control" id="validationCustom01" type="text" name="topic" placeholder="Add Mom topic" required="">
                </div>
                <div class="mb-3">
                  <label for="validationCustom03">Hosted / Chaired By</label>
                  <input class="form-control" id="validationCustom03" type="text" name="hosted" placeholder="please enter hosted by" required="">
                </div>
                <div class="mb-3">
                          <label class="form-label" for="validationCustom04">Meetings</label>
                ...
                <div class="mb-3">
                          <label class="form-label" for="memberid">Select Members</label>
                          <select  class="form-select" id="memberid" name="memberid" required="" >
                            <option selected disabled="" value="">Choose any one</option>
                            @foreach( $data['members'] as $cat)
                            <option value="{{$cat->uid}}">{{$cat->uname}}</option>
                            @endforeach
                          </select>
                          
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="responsibility">Select Responsibility</label>
                  ...
                  <textarea id="area1" class="form-control is-invalid"  name="details" cols="10" rows="2" required=""></textarea>
                </div>
                <div class="mb-3">
