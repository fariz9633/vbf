              ...
              <div class="col-sm-12">
                <div class="blog-single">
                  <div class="blog-box blog-details">
                    <!--<div class="card banner-wrraper"><img class="img-fluid w-100 bg-img-cover" src="{{asset('uploads/category')}}/<?=$category->image;?>" alt="blog-main"></div>-->
                    <div class="card">
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                            <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($category->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$category->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$category->name}} <?= $category->name_ka != ''  ? "--" : "";?> {{$category->name_ka}}
                          </h4>
                          ...
                          <div class="mt-2">
                              <img width="150" height="150" class="img-responsive " src="{{asset('uploads/category')}}/{{$category->image}}" alt="blog-main">
                        </div>
