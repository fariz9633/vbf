          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                <h6 class="font-roboto">Sub categories</h6>
                @php
                $total = DB::table('pwa_subcategory')->count();
                @endphp
          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                ...
                @php
                $data = DB::table('pwa_subcategory')->where('status', 1)->count();
                @endphp
          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                ...
                @php
                $data = DB::table('pwa_subcategory')->where('status', 2)->count();
                @endphp
                <h4 class="mb-0 counter">{{$data}}</h4>
              </div>
        ...
        <div class="card">
          <div class="card-header pb-0">
            ...
            <div class="mb-3 text-end">
              <a href="{{route('adminsubcategory.add')}}">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('body').on('click', '#show-delete', function () {
      ...
      $.ajax({
        type: "get",
        url: SITEURL + "/admin/subcategory/delete/"+_id,
