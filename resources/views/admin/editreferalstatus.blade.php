      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h5>Edit Priorities</h5>
          </div>
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.referalstatus.update', ["id"=>$referalstatus->id])}}" enctype='multipart/form-data'>
                @csrf
                @method('PUT')
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Title</label>
                  <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Priorities Title" value="{{$referalstatus->name}}" required>
                </div>
                ...
                <div class="mb-3">
                  <div class="media">
                    ...
                    <div class="media-body text-end">
                      <label class="switch">
                          @php
                          $chk = $referalstatus->status == '1' ? "checked" : " ";
                          @endphp
