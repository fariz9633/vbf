                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="mb-3 text-end">
                        <a href="{{route('adminnature.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Nature</button>
                        </a>
                    </div>
                   </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="nature" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Nature</th>
...
<script src="{{asset('admin/assets/js/datatable/datatables/jquery.dataTables.min.js')}}"></script>
    ...
    <script type="text/javascript">
		 ...
		 $(document).ready(function(){
                ...
                var table = $('#nature').DataTable({
					processing:true,
					serverSide:true,
					ajax: {
						url: "{{ url('admin/nature') }}"
					},
					columns: [
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/nature/delete/"+_id,
								success: function (data) {
									
									var oTable = $('#nature').dataTable();
									oTable.fnDraw(false);
								},
								error: function (data) {
