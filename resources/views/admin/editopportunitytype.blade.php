      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Requirement Type</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h5>Edit Requirement Type</h5>
          </div>
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.opportunitytype.update', ["id"=>$opportunitytype->id])}}" enctype='multipart/form-data'>
                @csrf
                @method('PUT')
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Title</label>
                  <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Requirement Type Title" value="{{$opportunitytype->name}}" required>
                </div>
                ...
                <div class="mb-3">
                  <div class="media">
                    ...
                    <div class="media-body text-end">
                      <label class="switch">
                          @php
                          $chk = $opportunitytype->status == '1' ? "checked" : " ";
                          @endphp
