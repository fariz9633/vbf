                      ...
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                            <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($referencetype->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$referencetype->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$referencetype->name}}
                          </h4>
