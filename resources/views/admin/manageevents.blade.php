                ...
                $va = explode(',', $rol->name);
                   ...
                   foreach($va as $resd)
                   {
                       if($resd == "Edit")
                       {
                        ...
                        <a href="{{route('adminevents.add')}}" class="btn btn-square btn-primary" > Add Events
                        </a>
                    </div>
                           <?php
                       }
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="events" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Name</th>
		 ...
		 $(document).ready(function(){
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/events/delete/"+_id,
