                ...
                $va = explode(',', $rol->name);
                   ...
                   foreach($va as $resd)
                   {
                       if($resd == "Edit")
                       {
                        ...
                        <a href="{{route('adminactivities.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Resources</button>
                        </a>
                    </div>
                           <?php
                       }
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <table class="display" id="activities" style="width:100%">
                        <thead>
                          <tr>
                           <th>#</th>
                            <th>Title</th>
		 ...
		 $(document).ready(function(){
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/activities/delete/"+_id,
