                ...
                $va = explode(',', $rol->name);
                   ...
                   foreach($va as $resd)
                   {
                       if($resd == "Edit")
                       {
                        ...
                        <a href="{{route('admincontent.add')}}">
                        <button class="btn btn-square btn-primary" type="button" data-bs-original-title="" title="">Add Content</button>
                        </a>
                    </div>
                           <?php
                       }
		 ...
		 $(document).ready(function(){
				...
				$('body').on('click', '#show-delete', function () {
					var _id = $(this).data("id");
						$.ajax({
								type: "get",
								url: SITEURL + "/admin/content/delete/"+_id,
