                      ...
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                            <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($referalstatus->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$referalstatus->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$referalstatus->name}}
                          </h4>
