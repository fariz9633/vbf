                      ...
                      <div class="card-body">
                        <div class="blog-details">
                          <ul class="blog-social">
                               <li><i class="fa fa-calendar-o"></i>{!! date('d M Y', strtotime($state->updated_at)) !!}</li>
                            <li><i class="fa fa-clock-o"></i><?=$state->status== '1' ? "Activated" : "Not-Activated";?></li>
                          </ul>
                          <h4>
                            {{$state->name}} <?= $state->name_ka != ''  ? "--" : "";?> {{$state->name_ka}}
                          </h4>
                          ...
                          <div class="mt-2">
                              <img width="150" height="150" class="img-responsive " src="{{asset('uploads/state')}}/{{$state->image}}" alt="blog-main">
                        </div>
