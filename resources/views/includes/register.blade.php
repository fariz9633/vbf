    ...
    <div class="content mb-0 mt-3">
        ...
        <form method="post" action="{{route('register.api')}}" enctype='multipart/form-data'>
            ...
            <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4 mt-2">
                <input type="text" class="form-control validate-text name" id="name" placeholder="{{ __('messages.regform1') }}" name="name" required>
                <label for="name" class="color-highlight">{{ __('messages.regform1') }}*</label>
                <i class="fa fa-times disabled invalid color-red-dark"></i>
                <i class="fa fa-check disabled valid color-green-dark"></i>
            </div>
             <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="number" class="form-control validate-text phone" id="phone" min="999999999" max="9999999999" placeholder="{{ __('messages.regform23') }}" name="phone" value="{{$details['number']}}" readonly required>
                <label for="phone" class="color-highlight">{{ __('messages.regform2') }}*</label>
                <i class="fa fa-times disabled invalid color-red-dark"></i>
                <i class="fa fa-check disabled valid color-green-dark"></i>
            </div>
             <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="email" class="form-control validate-text email" id="email" placeholder="{{ __('messages.regform24') }}" name="email" >
                <label for="email" class="color-highlight">{{ __('messages.regform3') }}</label>
                <i class="fa fa-times disabled invalid color-red-dark"></i>
                <i class="fa fa-check disabled valid color-green-dark"></i>
            </div>
            <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text password" id="password" placeholder="Enter the Password" value="" name="password" required>
             ...
             <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="file" class="form-control validate-text profile file-lt" id="profile" placeholder="{{ __('messages.regform41') }}" name="profile" >
                <label for="profile" class="color-highlight">{{ __('messages.regform41') }}</label>
            ...
            <!--    <select  required class="form-select roles profess-tag-1" id="roles" name="roles" data-placeholder="Select"  style="border-color: rgba(0, 0, 0, 0.08) !important;">-->
               
            <!--    </select>-->

            <!--</div>-->
            <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text city" id="city" placeholder="City" name="city" required>
                <label for="city" class="color-highlight">City*</label>
                <i class="fa fa-times disabled invalid color-red-dark"></i>
                <i class="fa fa-check disabled valid color-green-dark"></i>
            </div>
             <div class="input-style input-style-always-active has-borders no-icon validate-field mb-4">
                <input type="text" class="form-control validate-text pincode" id="pincode" placeholder="Enter the Pincode" value="" name="pincode" required>
                <label for="pincode" class="color-highlight">Pincode*</label>
            </div>
            @endif
            ...
            <div class="mt-4 input-style input-style-always-active has-borders no-icon  mb-4">
                <input type="email" class="form-control validate-text email" id="email" placeholder="{{ __('messages.regform24') }}" name="email" required>
                <label for="email" class="color-highlight">{{ __('messages.regform3') }}*</label>
                <i class="fa fa-times disabled invalid color-red-dark"></i>
                <i class="fa fa-check disabled valid color-green-dark"></i>
            </div>
