...
<div class="card card-style">
    ...
    <div class="content mt-2 mb-0">
        <h2 class="mb-3 color-highlight text-center">Registration</h2>
...
<p>{{ Session::get('error') }}</p>
        <form method="post" action="{{route('otp.store')}}">
            ...
            <div class="input-style no-borders has-icon validate-field mb-4">
                ...
                <input type="text" class="form-control validate-name" id="phone"  name="phone" pattern="[0-9]{10}" title="Please enter a 10-digit phone number" placeholder="Enter your mobile number" required>
